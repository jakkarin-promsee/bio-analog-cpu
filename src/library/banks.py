...
class Bank:
    def __init__(self, group_id, n_scaps, weight_bus, sign_bus, target_group, feedback,
                 get_weight, set_momentum, local_update, inits=None):
        ...
        self.scaps = [
            Scap(group_id, slot, weight_bus, sign_bus, target_group, feedback,
                 get_weight, set_momentum, local_update, init_weight=inits[slot])
...
class Ganglion(Bank):
    def __init__(self, group_id, *wires, inits=None):
        super().__init__(group_id, 29, *wires, inits=inits)
