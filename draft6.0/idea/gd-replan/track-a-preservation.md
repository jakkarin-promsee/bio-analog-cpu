...
>
> **⚠ POST-REVIEW CORRECTIONS (see [`review-and-revisions.md`](review-and-revisions.md), authoritative):** (1) **α
...
The repo's [`research/papers/phase3/direction-3-forward-only-alternatives.md`](../../research/papers/phase3/direction-3-forward-only-alternatives.md)
