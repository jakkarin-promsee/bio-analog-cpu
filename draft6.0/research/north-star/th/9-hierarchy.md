...
*Rao & Ballard, 1999; กรอบ: Friston. (ดู `4-signal.md`, `../../survey/predictive-coding.detail.md` ด้วย)*
...
- **BoostResNet** (`../../papers/phase1-2/boostresnet.md`): โต hierarchy ด้วย boosting (greedy optimal ในแง่ loss)
