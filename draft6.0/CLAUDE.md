...
- **Stage 2 continues → P8 · P9** — **P8** the economy gate + the cost meter (price RanPAC vs SLDA; decide *when* the namer fires) · **P9** the maintenance loop + owed baselines (BP+replay, A5, the read-side noise residual). Map: [`src/stage2-design.md`](src/stage2-design.md).
