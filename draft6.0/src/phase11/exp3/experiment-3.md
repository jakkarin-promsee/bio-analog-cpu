...
3. *Figures* — `STREAM_gas.png` (the headline — sleep staircase riding above persistence), `STREAM_har.png`,
   `STREAM_electric.png`, `STREAM_covtype.png` (the persistence wall visible batch-by-batch).
