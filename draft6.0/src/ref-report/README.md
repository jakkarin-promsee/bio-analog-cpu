...
> (`ref/`, `ref2/`, `concept/`) for the full story, and **back** to the phase reports where it's used.
>
> **What this is NOT.** Not a re-telling of the paper stories (those live in [`../../ref/`](../../ref/README.md)
> and [`../../ref2/`](../../ref2/README.md)) and not the algorithm detail (that's
> [`../../concept/`](../../concept/README.md)). If an entry grows past ~3 sentences, it belongs in one of those
...
| [`papers.md`](papers.md) | the citation table — paper, people, arXiv, one-line why, link to the `ref/` story | naming the source without a paragraph |

## Convention for every entry

```
### <term>   (the header doubles as a one-line gloss, so the set is reviewable at a glance)
<short definition — 1–3 sentences; if it grows past that, move it to ref/ ref2/ concept/ and just link>
- **Onward:** <link to the deep story in ref/ ref2/ concept/, and papers.md for a paper>
