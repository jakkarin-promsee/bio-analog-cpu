...
> **Status: ✅ COMPLETE (2026-06-21, P2.0 → P2.6).** This file (`design.md`) is the original **experiment design**
> (kept as the record of what was proposed, *not* an open to-do); the **results + verdict** live in the [`README.md`](README.md) front door (the
...
> Read the plan below for the *aims*; read the [`README.md`](README.md) for *what happened*. Builds on the Phase-1 verdict in
...
| **Phase 2** | *this* — depth round 1: can a deep *energy-goodness* SCFF stack earn depth? (no) | **done** (P2.0/1/2/5/6; P2.3/4 skipped) — see [`README.md`](README.md) |
