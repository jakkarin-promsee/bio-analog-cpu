...
- **Authoritative record:** [`phase4-summarize.md`](phase4-summarize.md) + [`RESULTS.md`](RESULTS.md) + the one-glance [`figs_summary/CAPABILITY_MAP.png`](figs_summary/CAPABILITY_MAP.png). **Story:** [`phase4-report.md`](phase4-report.md).
...
- **Read-budget:** to use this phase from elsewhere, read **`phase4-summarize.md` only**; open cards/code only to modify them.
