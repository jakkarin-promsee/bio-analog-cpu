...
> [`README.md`](README.md), ledger: [`RESULTS.md`](RESULTS.md), the assembled map:
...
- **P4.7 — the synthesis: the capability map.** ✅ **DONE (2026-06-22)** — [`README.md`](README.md)
...
- ✅ **The phase renumber** (P4 = characterize, P5 = optimize) — endorsed by the author and **synced 2026-06-23**
  to `CLAUDE.md` / `context.md` / `main.ideas.v1.md`. The phase-2/3 plan files are left period-correct (the
  renumber is narrated in `../phase2/README.md`).
...
- Carry-overs: **Mono-Forward** ([2501.09238](https://arxiv.org/abs/2501.09238)), the Phase-3 cell
  ([`../phase3/README.md`](../phase3/README.md)), `result-format` lineage (Phase 1–3).
