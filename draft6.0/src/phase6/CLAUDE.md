...
- **The front door (read this first):** [`README.md`](README.md). **The deep story with every figure:**
  [`phase6-report.md`](phase6-report.md). **Numbers:** [`RESULTS.md`](RESULTS.md) (P6.0–P6.8 + scorecard).
  **Per-rung story:** [`expK/experiment-K.md`](exp0/experiment-0.md). **Spec:** [`design.md`](design.md); contract
  [`result-format.md`](result-format.md). **Apparatus:** `p6lib.py` (+ `plot_p6.py`).
