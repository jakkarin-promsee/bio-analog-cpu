...
*Doc sync (this commit):* CLAUDE.md, `idea/main.ideas.v1.md`, `context.md`, `phase2/README.md` §8 +
`phase2-summarize.md`, and the memory index updated to the new numbering.
...
[`../phase2/phase2-summarize.md`](../phase2/phase2-summarize.md).
