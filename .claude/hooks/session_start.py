...
Context is layered; load your tier and STOP:
  root CLAUDE.md (loaded) -> draftN/CLAUDE.md (auto in-draft) -> phaseN/CLAUDE.md (signpost) -> phaseN-summarize.md (detail)
Live line = draft6.0/ (Stage 1 done; Phase 5 = next).  History = draft5.0/.  Idea journey = draft-journey/.
...
Heavy lookup? read ONE phaseN-summarize.md, or dispatch the Explore subagent.
