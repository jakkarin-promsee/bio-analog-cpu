...
| "What did Phase 2 (depth) find?"           | `draft6.0/src/phase2/phase2-summarize.md` (the synthesis) + `RESULTS.md` (ledger) — **Phase 2 done** |
