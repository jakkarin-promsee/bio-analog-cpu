...
- **Draft 6.0 spine: committed and now measured.** The decisions (N1–N3 + S1–S14) are in `draft6.0/idea/main.ideas.v1.md`; the ten phases ran and set the open knobs. Nothing was "locked" the way draft-5.1's §22 was; 6.0 earned its commitments from results.
